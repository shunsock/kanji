...
class TestKanjiPair:
    ...
    def test_invalid_kanji_pair_length(self):
        ...
        with pytest.raises(ValueError, match="Both kanji characters must be single characters."):
    ...
    def test_same_kanji_pair(self):
        ...
        with pytest.raises(ValueError, match="Old and new kanji characters must be different."):
